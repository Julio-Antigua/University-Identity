...
<div class="signin">
    <div class="wrapper fadeInDown">
      <div id="formContent">
        ...
        <h4 class="text text-danger">Register</h4>
        ...
        <form v-on:submit.prevent="signin()">        
          ...
          <input type="text" id="password" class="fadeIn fourth" name="login" placeholder="Password" v-model="password">
          <input type="submit" class="fadeIn fifth" value="Sign In">
        </form>

        <div id="formFooter">
          <a class="underlineHover" v-on:click="login()">Login In!</a>
        </div>
...
export default{
    ...
    methods: {
        signin(){
            ...
            axios.post('https://localhost:44307/api/Auth/signin',json).then(data => {
